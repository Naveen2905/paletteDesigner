...
//Naveen's Key google : e429c44d3e5e48beacacf5b14cc993a2
//Naveen's Secondary Key live : 0d411c50c97a49d5a155391721a6abea
    ...
    $.ajax({
        ...
        if (result == false) {
            ...
            result.forEach(function (eachRecipe) {
                ...
                //     data: {
                //         apiKey: recipeApp.key,
                //         food: ingredientInput
                //     }
                // }).then(function(eachWine){
                //     console.log(eachWine);
                //    const winePairing = eachWine.pairingText;
                //    console.log(winePairing);
                   
                //    const pToAppend = `<p class="wineInfo">${winePairing}</p>`
                // //    $(this). 
                //    $('div.results').append(pToAppend);
                // })
